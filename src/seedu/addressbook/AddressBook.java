...
public class AddressBook {
     ...
     */
    /* (1) Under Use Collections [LO-Collections], the code is modified to use a
     * HashMap<String, String> instead. Thus, a person's details are not saved
     * as the nth element (which was originally done so).
     * (2) Generally, we can search for String[] and replace it with
     * HashMap<String, String> where appropriate.
     * (3) Secondly, we replace PERSON_DATA_INDEX_<DETAIL> with PERSON_PROPERTY_<DETAIL>.
     * As a result of not storing a person's details in a String and accessing it by index,
     * get method (1 parameter) from HashMap is used instead when retrieving data.
     * (4) If we are inserting data and forming a new person,
     * the put method (2 parameters) is used instead.
     */
     ...
     * ====================================================================================================
     */
    /* Under Use Collections [LO-Collections], the code is modified to use a
     * HashMap<String, String> instead.
     */
